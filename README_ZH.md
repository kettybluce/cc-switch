...
覆盖 SCHEMA 18 的 Pi/Claude/Codex 夹具（含 #51 接管往返）。自测工作之后出绿色版/MSI **必须**附这份全量报告。**不覆盖** WSL UNC、Windows MSI/绿色版安装、完整桌面 GUI。SCHEMA 保持 18。详见 [docs/docker-backend-self-test.md](docs/docker-backend-self-test.md)。
