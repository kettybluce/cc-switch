...
This covers SCHEMA 18 Pi/Claude/Codex fixtures including takeover roundtrips (#51) and isolated-HOME JSONL usage scan (#64). After self-test work, shipping Portable/MSI **requires** this full-suite report. It does **not** cover WSL UNC, Windows MSI/Portable install, or the full desktop GUI. SCHEMA stays 18. See [docs/docker-backend-self-test.md](docs/docker-backend-self-test.md).
